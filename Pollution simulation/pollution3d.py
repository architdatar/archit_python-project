...
#getting kxx, kyy,kzz from sutton params for an array of x
...
#line source
c[4,2:5,0]= Q/(delta_x*delta_y*delta_z)*10**-6 #need a better way to define this and do the calculation for the Q
# 
...
for t_loop in range(int(time_steps_for_simulation)):
    ...
    c[4,2:5,0]= Q/(delta_x*delta_y*delta_z)*10**-6
...
# make the Q variable with time for factory
